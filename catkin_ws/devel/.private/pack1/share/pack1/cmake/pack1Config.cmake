...
if("TRUE" STREQUAL "TRUE")
  set(pack1_SOURCE_PREFIX /home/lara/catkin_ws/src/pack1)
  set(pack1_DEVEL_PREFIX /home/lara/catkin_ws/devel/.private/pack1)
  set(pack1_INSTALL_PREFIX "")
  set(pack1_PREFIX ${pack1_DEVEL_PREFIX})
else()
  set(pack1_SOURCE_PREFIX "")
  set(pack1_DEVEL_PREFIX "")
  set(pack1_INSTALL_PREFIX /home/lara/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pack1' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lara/catkin_ws/src/pack1/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/lara/catkin_ws/devel/.private/pack1/lib;/home/lara/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
